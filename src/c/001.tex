...
\fig{c/image2}{Fig.1 -- Initial samples of the phosphate raw material
processing waste}
...
\begin{multicols}{2}
\fig[0.2\textwidth]{c/image3}{Fig.2 - Daphnia magna}
...
\tcap{Table 1 - Conditions for the biotesting procedure}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 2 - Results of calculating the survival rate of daphnia}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 3 - Oxygen concentration in the tested samples at the end of the experiment}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 4 - Conditions for the biotesting procedure}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 5 - Results of calculating the survival rate of daphnia}
\begin{longtblr}[
  label = none,
  entry = none,
]{
...
\tcap{Table 6 - Assignment of hazard class according to the dilution factor of the aqueous extract}
\begin{longtblr}[
  label = none,
  entry = none,
]{
